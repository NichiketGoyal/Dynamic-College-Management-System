...
<div class="modal" align="center">
	<form action="reg_exec_emp.php" method="post" name="reg" onsubmit="return validateForm()">
	<table>
  ...
  <tr><td><label>Department</label></td><td><input type="text" name="dept" required></td></tr>
