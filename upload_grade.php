...
echo "<center><form action='result_teach_exec.php' method='post'><table border=1 style='margin-left:-100px;'>
<tr>
...
echo "<button style='width:200px;margin-left:300px'>Update Marks</button>";
