...
<body id="bkg">
<div class="i_box2">
    <img src="pics/box1.jpg" height="870px" width="1030px">
</div>
<div id="navbar">

    <a href="accounts.php" class="active">Profile</a>
         ...
         <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
          ...
          <td><br><br>
            <b>Name:</b>&nbsp;&nbsp;<?php echo $name; ?><br> <br>
                <b>Employee ID:</b> <?php echo $uid; ?><br><br>
